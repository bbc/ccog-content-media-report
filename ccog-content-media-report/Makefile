...
BUCKET = map-input-output/ccog-content-media-report
PROFILE = default
PROJECT_NAME = ccog-content-media-report
R_COMMAND = Rscript
...
renv/created.ignore:
	...
	$(R_COMMAND) -e "renv::settings[['external.libraries']]('/opt/conda/lib/R/library')"
...
docker: docker_build
	...
	@echo ">>> docker exec -it ccog-content-media-report /bin/bash"
